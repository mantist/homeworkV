...
class LPCalculatorTest {
  ...
  void calcSPrice() {
    ...
    assertEquals("LP S price", price, tl.getEffectivePrice());
  }
  ...
  void calcMPrice() {
    ...
    lp_calc.calcPrice(tl);
    assertEquals("LP M price", price, tl.getEffectivePrice());
  }
  ...
  void calcLPrice() {
    ...
    lp_calc.calcPrice(tl);
    assertEquals("LP L price", price, tl.getEffectivePrice());
  }
  ...
  void applyNthLFree() {
    ...
    assertEquals("1 st. L LP delivery in 2018-04",
                  lp_l_full,
    ...
    tl.setPrice(lp_l_full);
    lp_calc.calcDiscount(tl);
    assertEquals("1 st. L LP delivery in 2017-04",
                  lp_l_full,
                  tl.getEffectivePrice());
    ...
    lp_calc.calcDiscount(tl);
    assertEquals("1 st. M LP delivery in 2018-04",
                  lp_m_full,
                  tl.getEffectivePrice());
    ...
    tl.setPrice(lp_l_full);
    lp_calc.calcDiscount(tl);
    assertEquals("2 nd. L LP delivery in 2018-04",
                  BigDecimal.ZERO,
                  tl.getEffectivePrice());
    ...
    tl.setPrice(lp_l_full);
    lp_calc.calcDiscount(tl);
    assertEquals("2 nd. L LP delivery in 2017-04",
                  BigDecimal.ZERO,
                  tl.getEffectivePrice());
    ...
    tl.setPrice(lp_m_full);
    lp_calc.calcDiscount(tl);
    assertEquals("2 nd. M LP delivery in 2018-04",
                  lp_m_full,
                  tl.getEffectivePrice());
    ...
    tl.setPrice(lp_l_full);
    lp_calc.calcDiscount(tl);
    assertEquals("3 rd. L LP delivery in 2018-04",
                  lp_l_full,
                  tl.getEffectivePrice());
  }
}